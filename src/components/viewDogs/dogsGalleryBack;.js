...
class DogsGallery extends React.Component {
    ...
    calculateIndependenceNew(dogIndependence, userIndependence) {
        ...
        //Independence 
        if (userIndependence >= THRESHOLD_VALUES.INDEPENDENCE || dogIndependence >= THRESHOLD_VALUES.INDEPENDENCE) {
    ...
    calculateConfidenceNew(dogConfidence, userConfidence) {
        //Confidence 
        if (userConfidence >= THRESHOLD_VALUES.CONFIDENCE && dogConfidence >= THRESHOLD_VALUES.CONFIDENCE) {
